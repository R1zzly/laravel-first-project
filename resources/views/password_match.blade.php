...
@endif
<form method="post" action="{{route('password.matchete')}}">
    @csrf
    <div class="input-group mb-3" style="width: 800px; margin: auto; padding-top: 15px">
        <input type="text" name="reset_code" class="form-control" placeholder="Number" aria-label="reset_code" aria-describedby="basic-addon2" required>
    </div>
    <div class="input-group mb-3" style="width: 800px; margin: auto; padding-top: 15px">
